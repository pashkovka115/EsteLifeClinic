                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="form-group">
                            <label>Ссылка на эту страницу</label>
                            <p class="form-control">
                                <a href="{{ route('front.page.show', ['slug' => $page->slug]) }}" target="_blank">{{ route('front.page.show', ['slug' => $page->slug]) }}</a>
                            </p>
                        </div>
                        <div class="form-group">
