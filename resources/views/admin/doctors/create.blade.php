...
@section('title', 'Врачи')
@section('pageName', 'Создать врача')
@section('breadcrumbs')
    <li class="breadcrumb-item active">Создать врача</li>
@endsection
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="checkbox my-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="level" class="custom-control-input" id="customCheck3" data-parsley-multiple="groups" data-parsley-mincheck="2">
